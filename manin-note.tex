...
\title{Manin triples and spheres}
\author{Ingmar, for Brian and Surya}
...
Doing so yields
\[
\frac12 [\pi_+[x,y_1],y_2] \otimes  \sigma^2 - \frac12 [\pi_+[x,y_1],y_2] \otimes \sigma.
\]
Bracketing again, we obtain
\[
\frac12 [\pi_+[x,y_1],y_2], y_3] \otimes (\sigma^2 - \sigma) \, d\sigma.
\]
Upon applying the projection, this becomes
\[
-\frac{1}{12} \pi_- [\pi_+[x,y_1],y_2], y_3].
\]
